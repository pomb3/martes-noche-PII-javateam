...
public class Main {
    ...
    public static void probarPila(String nombre, PilaTDA pila) {
        ...
        System.out.println("Apliando la palabra: " + palabra);
        for (int i = 0; i < 10; i ++){
            pila.Apilar(String.valueOf(palabra.charAt(i)));
        }
        System.out.println("Tope luego de insertar toda la palabra: " + pila.Tope());

        System.out.println("\nComenzando a desapilar:");
        while(!pila.PilaVacia()){
            System.out.println("Tope actual: " + pila.Tope());
            pila.Desapilar();
        }

        System.out.println("\n¿Pila vacia?: " + pila.PilaVacia());
        System.out.println();
    }
}