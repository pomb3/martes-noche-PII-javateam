...
🎓 Actualmente estoy cursando la carrera de Ingeniería en Informática en la UADE (Universidad Argentina de la Empresa).

🎬 Vengo del mundo de la producción audiovisual y el motion design, lo que me da una ventaja creativa a la hora de desarrollar interfaces de usuario que no solo sean funcionales, sino también visualmente atractivas.

🚀 Me apasiona crear soluciones digitales innovadoras que destaquen tanto por su funcionalidad como por su atractivo visual.

🌱 Siempre aprendiendo y manteniéndome al día con las nuevas tendencias tecnológicas.
